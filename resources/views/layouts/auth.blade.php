...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="http://localhost/viho/theme/public/assets/images/favicon.png" type="image/x-icon" />
        <link rel="shortcut icon" href="http://localhost/viho/theme/public/assets/images/favicon.png" type="image/x-icon" />
